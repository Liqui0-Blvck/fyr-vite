...
const FormularioRegistroOperarioPrograma: FC<IFormCamiones> = ({ refresh, setOpen }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const res = await fetch(`${base_url}/api/produccion/${id}/operarios/`, {
          method: 'POST',
          headers: {
...
export default FormularioRegistroOperarioPrograma
