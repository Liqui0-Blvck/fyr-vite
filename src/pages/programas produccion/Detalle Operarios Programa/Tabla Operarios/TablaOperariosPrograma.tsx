...
import { TControlCalidad, TOperarioProduccion, TProduccion, TRendimientoMuestra } from '../../../../types/registros types/registros.types';
...
const TablaOperariosPrograma: FC<IRendimientoMuestra> = ({ operarios, refresh, programa_produccion }) => {
