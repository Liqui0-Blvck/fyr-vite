...
const CardFrutaCalibrada: FC<ICardFrutaCalibradaProps> = ({ rendimiento }) => {
  const labels: string[] = Object.keys(rendimiento ? rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas!: {})
                ...
                <div className='grid grid-cols-4 gap-x-5 gap-y-2'>
                  <div className='md:col-span-2'>
                    ...
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.precalibre! * rendimiento?.cc_calculo_final?.final_exp! / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:col-start-3 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Calibre 18/20</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_18_20 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-2 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Hongo</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_20_22 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-2 md:col-start-3 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Daño Insecto</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_23_25 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-3 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Dobles</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_25_27 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-3 md:col-start-3 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Vana Deshidratada</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_27_30 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-4 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Mezcla Variedad</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_30_32 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-4 md:col-start-3 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Fuera Color</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_32_34 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-5 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Goma</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_34_36 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  <div className='md:row-start-5 md:col-start-3 md:col-span-2 '>
                    <Label htmlFor='' className='text-center'>Punto Goma</Label>
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_36_40 * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                  ...
                  <div className='md:row-start-6 md:col-span-2 '>
                    ...
                    <div className='flex items-center justify-center dark:bg-zinc-700 bg-zinc-200 py-2 px-3 rounded-md'>
                      <span>{(rendimiento?.cc_promedio_porcentaje_cc_pepa_calibradas?.calibre_40_mas * rendimiento?.cc_calculo_final?.final_exp / 100).toFixed(1)} kgs</span>
                    </div>
                  </div>
                </div>
              </div>
