...
import { TEnvasesPrograma, TProduccion, TReprocesoProduccion } from "../../../types/registros types/registros.types";
...
const CardMetricaRecepcion: FC<ICardFrutaCalibradaProps> = ({ envases_programa, programa }) => {
	const totalEnvases = programa?.bins.length || 1; 
