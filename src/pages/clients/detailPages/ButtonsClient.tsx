...
type TButtonKey = 'INFORMACION_PERSONAL' | 'NOTAS' | 'INTERACCIONES' | 'AGENDA' | 'ESTRATEGIAS' | 'INVERSIONES' 
type TButtonText = 'Información Personal' | 'Notas' | 'Interacciones' | 'Agenda' |	'Estrategias' | 'Inversiones' 
